/*
    This program will update a client's information and write over
    the previous information to update it. After updating, the user will
    be redirected to the functions page.
*/
...
int main(int argc, char* argv[]) {
    ...
    if(conn.connect("cse278", "localhost", "cse278", "MonSepM1am1")) {
        ...
        query << "UPDATE 01757392Clients SET firstName = '"+firstName+"', lastName = '"+lastName+"', phoneNumber = '"+phoneNumber+"', address = '"+address+"', petName = '"+petName+"', breed = '"+breed+"', age = '"+age+"', allergies = '"+allergies+"', size = '"+size+"', groomedBefore = '"+groomedBefore+"', generalBehavior = '"+generalBehavior+"', cageShy = '"+cageShy+"', vet = '"+vet+"' WHERE firstName = '"+firstName+"' AND lastName = '"+lastName+"'";
        ...
        if(result) {
            ...
            cout << "<title>Updating client information</title>" << endl;
            cout << "<link rel=\"stylesheet\" href=\"css/style.css\" media=\"screen\" type=\"text/css\" />" << endl;
            cout << "</head>" << endl;
            cout << "<p><br></br><font size=\"+3\"><pre>update successful, redirecting back functions page, please wait.</pre></font></p>" << endl;
