/*
    This program will display all client information is a table format.
    If there are no clients, no information will be listed.
*/
...
int main(int argc, char* argv[]) {
    ...
    if(conn.connect("cse278", "localhost", "cse278", "MonSepM1am1")) {
        ...
        query << "SELECT * FROM 01757392Clients;";  
        ...
        // Creates table for all client's information
        if(result) {
        cout << "Content-type: text/html" << endl << endl;
        cout << "<html><head>" << endl;
        cout << "<title>All client info</title>" << endl;
        cout << "<head>" << endl;
        cout << "<meta charset=\"UTF-8\">" << endl;
        cout << "<title>View all client's information</title>" << endl;
